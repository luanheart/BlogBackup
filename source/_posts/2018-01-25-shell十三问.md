...
> 转自 https://github.com/wzb56/13_questions_of_shell

## 目录

1. [shell十三问之1: 何为shell？](#shell十三问之1: 何为shell？)
2. [shell十三问之2：shell prompt(PS1)与Carriage Return(CR)关系](#shell十三问之2：shell-prompt-PS1-与Carriage-Return-CR-关系)
3. [shell十三问之3：别人echo、你也echo，是问echo知多少？](#shell十三问之3：别人echo、你也echo，是问echo知多少？)
4. [shell十三问之4：""(双引号)与''(单引号)差在哪？](#shell十三问之4：””-双引号-与’’-单引号-差在哪？)
5. [shell十三问之5：问var=value 在export前后的差在哪？](#shell十三问之5：问var-value-在export前后的差在哪？)
6. [shell十三问之6：exec跟source差在哪？](#shell十三问之6：exec跟source差在哪？)
7. [shell十三问之7：()与{}差在哪？](#shell十三问之7：-与-差在哪？)
8. [shell十三问之8: $(())与$()还有${}差在哪？](#shell十三问之8-与-还有-差在哪？)
9. [shell十三问之9：$@与$*差在哪？](#shell十三问之9：-与-差在哪？)
10. [shell十三问之10：&& 与 || 差在哪？](#shell十三问之10：-amp-amp-与-差在哪？)
11. [shell十三问之11：>与< 差在哪？](#shell十三问之11：-gt-与-lt-差在哪？)
12. [shell十三问之12：你要if还是case呢？](#shell十三问之12：你要if还是case呢？)
13. [shell十三问之13： for what？ while与until差在哪？](#shell十三问之13：-for-what？-while与until差在哪？)
14. [shell十三问之14: [^ ] 跟[! ]差在哪？ (wildcard)](#shell十三问之14-跟-差在哪？-wildcard)
15. [shell十三问之15: [^ ] 跟[! ]差在哪？ (RE: Regular Expression）](#shell十三问之15-跟-差在哪？-RE-Regular-Expression）)
16. [shell十三问之16：学习总结与原帖目录](#shell十三问之16：学习总结与原帖目录)
